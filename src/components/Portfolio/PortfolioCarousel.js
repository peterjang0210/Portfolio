...
const items = [
  ...
  {
    // src: fieldServiceAppDemo,
    altText: "Alba 2.0",
    title: "Field Service App",
    description: "This app is currently in development. This app was developed with the intention of replacing Alba as the primary application used during field service in my congregation. We found that many of the older friends struggled with the smaller text and UI in Alba and that they struggled to navigate efficiently between houses as the addresses were displayed in alphabetical order. Although Alba is a great application, this app is my attempt to fix some of those issues for the older friends in the hall. Firstly, the text and buttons in the UI are much bigger and therefore easier to read. Another feature is that the doors are arranged in a set order so that there is minimal travel time between houses. This application also has a more robust record keeping feature so that the friends are more aware of the householder's circumstances before their call. Currently, this application contains most of the features included in Alba except for the ability to import a large number of addresses at once, auto assigning addresses to already created cards based on their location, and display the addresses on the card on a map. These features are currently in progress.",
    challenge: "The repository for this project is currently set to private and as such cannot be viewed without requesting access. The live version of the app can be logged in via the username: John Doe and phone number: 1112223333.",
    githubLink: "https://github.com/peterjang0210/Field-Service-App",
    deployedLink: "https://github.com/peterjang0210/Field-Service-App"
  }
];
